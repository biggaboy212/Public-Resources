...
local L_8_ = game:GetService("Players").LocalPlayer.PlayerGui
	...
	function L_137_:MakeTab(L_142_arg1)
		...
		local function L_145_func(L_152_arg1)
			...
			function L_153_:AddSlider(L_175_arg1)
				...
				local Clip = Instance.new("Frame", L_178_)
				Clip.AnchorPoint = Vector2.new(1,0)
				Clip.Position = UDim2.new(1,0,0,0)
				Clip.Size = UDim2.new(0.5,0,1,0)
				Clip.BorderSizePixel = 0
				Clip.BackgroundColor3 = L_175_arg1.Color
				Clip.Visible = false
				local ClipCorner = Instance.new("UICorner", Clip)
				ClipCorner.CornerRadius = UDim.new(0,0)
				L_179_.Value.ZIndex = 2
				L_178_.Value.ZIndex = 2
				...
				function L_176_:Set(L_182_arg1)
					...
					local difference = L_179_.AbsoluteSize.X - L_178_.AbsoluteSize.X
					ClipCorner.CornerRadius = UDim.new(0, math.max(0, 5 - difference))
					L_175_arg1.Callback(L_182_arg1)
				end
				L_178_:GetPropertyChangedSignal("AbsoluteSize"):Connect(function()
					local difference = L_179_.AbsoluteSize.X - L_178_.AbsoluteSize.X
					ClipCorner.CornerRadius = UDim.new(0, math.max(0, 5 - difference))
				end)
